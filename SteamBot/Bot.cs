...
namespace SteamBot
{
    public class Bot : IDisposable
    {
        ...
        private void BackgroundWorkerOnDoWork(object sender, DoWorkEventArgs doWorkEventArgs)
        {
            ...
            callbackManager.Subscribe<SteamUser.WebAPIUserNonceCallback>(webCallback =>
            {
            ...
            #region Group Chat
            callbackManager.Subscribe<SteamFriends.ChatMsgCallback>(callback =>
            {
            ...
            #region Trading
            callbackManager.Subscribe<SteamTrading.SessionStartCallback>(callback =>
            {
            ...
            callbackManager.Subscribe<SteamTrading.TradeProposedCallback>(callback =>
            {
            ...
            callbackManager.Subscribe<SteamTrading.TradeResultCallback>(callback =>
            {
            ...
            callbackManager.Subscribe<SteamBot.SteamNotifications.NotificationCallback>(callback =>
            {
            ...
            callbackManager.Subscribe<SteamBot.SteamNotifications.CommentNotificationCallback>(callback =>
            {
