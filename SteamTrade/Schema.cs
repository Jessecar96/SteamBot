...
namespace SteamTrade
{
    ...
    public class Schema
    {
        ...
        /// </summary>
        public static string CacheFileFullName
        {
            get { return cacheFileFullName; }
            set { cacheFileFullName = value; }
        }
        private static string cacheFileFullName = Path.GetTempPath() + "\\tf_schema.cache";
